...
LCL VOID CTYP _main_OPEN(NOARG)
{
 ...
 CurHide();
  ...
  Wmessage("Сохранить как...",BRD_TOP,19,_BLUE|INTENSE|LGREY);
  Wbprintc(BRD_TOP,35,_BLUE|LGREY,'├');
  Wprts(0,3,_BLUE|LGREY,"Введите");
  Wprts(0,11,_BLUE|LGREY,"новое");
  Wprts(0,17,_BLUE|LGREY,"имя");
  Wprts(0,21,_BLUE|LGREY,"файла");
  Wprts(0,27,_BLUE|LGREY,":");
...
{
if(filename[0]) EdtSaveAs(filename);     
  return;
}
